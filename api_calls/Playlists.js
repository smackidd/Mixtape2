...
const getArtistsPlaylists = async (artist, limit=10, offset=0) => {
    ...
    try {
      ...
      console.log("getArtistsPlaylist", data.playlists.items);
      return data;
    } catch(err) {
      console.log(err)
    } 
  ...
  const getNextUsersPlaylists = async (url) => {
    const accessToken = await AsyncStorage.getItem('token');
    const country = await AsyncStorage.getItem('country');
    try {
      ...
      const data = await response.json();
      console.log("getNextPlaylists", data.items);
      return data;
    } catch(err) {
      console.log(err)
    } 
  ...
  const getBrowseCategories = async (limit=20, offset=0) => {
    ...
    try {
      ...
      const data = await response.json();
      console.log("getBrowseCategories", data.categories.items);
      return data;
    } catch(err) {
      console.log(err)
    } 
  ...
  const getBrowseCategoryWithId = async (id, limit=20, offset=0) => {
    ...
    try {
      ...
      const data = await response.json();
      console.log("getBrowseCategoryWithId", data);
      return data;
    } catch(err) {
      console.log(err)
    } 
  ...
  const getSingleBrowseCategoryWithId = async (id) => {
    const accessToken = await AsyncStorage.getItem('token');
    const country = await AsyncStorage.getItem('country');
    try {
      ...
      const data = await response.json();
      console.log("getSingleBrowseCategoryWithId", data);
      return data;
    } catch(err) {
      console.log(err)
    } 
...
export {getArtistsPlaylists, getPlaylistItems, getUsersPlaylists, getCategoryPlaylists, getBrowseCategories, getBrowseCategoryWithId, getNextUsersPlaylists, getSingleBrowseCategoryWithId};